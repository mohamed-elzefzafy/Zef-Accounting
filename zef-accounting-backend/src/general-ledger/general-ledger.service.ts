...
//   // ✅ 5- Opening Balance من جدول opening_balances مباشرةً
//   const openingData = await this.openingBalanceService.getOpeningBalanceForLedger(
//     accountId,
//     startYear,
//     costCenter,
//   );

//   // ✅ لو السنة السابقة مفتوحة → وضح للمستخدم إن الرصيد تقديري
//   const isEstimated = openingData.isEstimated;

//   // الرصيد الافتتاحي = debit - credit
//   let openingBalance = openingData.openingDebit - openingData.openingCredit;

//   // 6- القيود داخل الفترة (بس من السنة الحالية)
//   const entries = await this.journalEntryRepository.find({
//     where: {
//       date: Between(effectiveStartDate, effectiveEndDate),
//       isClosing: false,  // ✅ استبعد قيود الإقفال
//       isOpening: false,  // ✅ استبعد قيود الافتتاح القديمة
//     },
//     relations: ['lines', 'lines.account', 'lines.costCenter', 'fiscalYear'],
//     order: { date: 'ASC', sequenceNumber: 'ASC' },
//   });
...
//     fiscalYear: startYear,
//     isOpeningBalance: true,
//     isEstimated,  // ✅ الـ frontend يقدر يلون السطر ده بالأصفر مثلاً
//   });
...
//     ledger,
//     totals,
//     isEstimated,  // ✅ تحذير للـ frontend
//     fiscalYears: fiscalYears.map((fy) => ({
//       id: fy.id,
//       year: fy.year,
//       isClosed: fy.isClosed,
